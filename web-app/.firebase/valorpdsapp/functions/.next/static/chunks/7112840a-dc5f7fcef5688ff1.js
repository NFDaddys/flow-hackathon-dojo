"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(e,t,n){n.d(t,{JU:function(){return rZ},QT:function(){return sC},ad:function(){return r7},pl:function(){return sA}});var r,s,i=n(5816),a=n(8463),o=n(3333),l=n(4444),u=n(3510);n(3454);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t,n){if(!n)throw new T(E.INVALID_ARGUMENT,`Function doc() cannot be called with an empty ${t}.`)}(0,"path",t),e instanceof rH){let r=M.fromString(t,...n);return rz(r),new rY(e,null,new q(r))}{if(!(e instanceof rY||e instanceof rJ))throw new T(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let r=e._path.child(M.fromString(t,...n));return rz(r),new rY(e.firestore,e instanceof rJ?e.converter:null,new q(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new sn(Z.fromBase64String(e))}catch(e){throw new T(E.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new sn(Z.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sE{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class sT extends sp{constructor(e,t,n,r,s,i){super(e,t,n,r,i),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new sI(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let n=this._document.data.field(sv("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class sI extends sT{data(e={}){return super.data(e)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sC(e){e=r$(e,rY);let t=r$(e.firestore,r8);return(function(e,t,n={}){let r=new I;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,s){var i;let a=new r0({next:i=>{t.enqueueAndForget(()=>rf(e,o));let a=i.docs.has(n);!a&&i.fromCache?s.reject(new T(E.UNAVAILABLE,"Failed to get document because the client is offline.")):a&&i.fromCache&&r&&"server"===r.source?s.reject(new T(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(i)},error:e=>s.reject(e)}),o=new ry((i=n.path,new eY(i)),a,{includeMetadataChanges:!0,Nu:!0});return rd(e,o)})(await r5(e),e.asyncQueue,t,n,r)),r.promise})(se(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),s=new sS(e);return new sT(e,s,t._key,r,new sE(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sS extends sw{constructor(e){super(),this.firestore=e}convertBytes(e){return new sn(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new rY(this.firestore,null,t)}}function sA(e,t,n){var r,s;e=r$(e,rY);let i=r$(e.firestore,r8),a=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return s=[(function(e,t,n,r,s,i={}){let a,o;let u=e.da(i.merge||i.mergeFields?2:0,t,n,s);sd("Data must be an object, but it was:",u,r);let h=function e(t,n){let r={};return X(t)?n.path&&n.path.length>0&&n.fieldMask.push(n.path):Y(t,(t,s)=>{let i=function t(n,r){if(sc(n=(0,l.m9)(n)))return sd("Unsupported field value:",r,n),e(n,r);if(n instanceof ss)return function(e,t){if(!sl(t.sa))throw t.ha(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.ha(`${e._methodName}() is not currently supported inside arrays`);let n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(n,r),null;if(void 0===n&&r.ignoreUndefinedProperties)return null;if(r.path&&r.fieldMask.push(r.path),n instanceof Array){if(r.settings.oa&&4!==r.sa)throw r.ha("Nested arrays are not supported");return function(e,n){let r=[],s=0;for(let i of e){let e=t(i,n.aa(s));null==e&&(e={nullValue:"NULL_VALUE"}),r.push(e),s++}return{arrayValue:{values:r}}}(n,r)}return function(e,t){if(null===(e=(0,l.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e){var n,r,s;return n=t.yt,"number"==typeof(s=r=e)&&Number.isInteger(s)&&!J(s)&&s<=Number.MAX_SAFE_INTEGER&&s>=Number.MIN_SAFE_INTEGER?e6(r):e5(n,r)}if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let n=V.fromDate(e);return{timestampValue:tj(t.yt,n)}}if(e instanceof V){let n=new V(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:tj(t.yt,n)}}if(e instanceof si)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof sn)return{bytesValue:tW(t.yt,e._byteString)};if(e instanceof rY){let n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.ha(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:tY(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ha(`Unsupported field value: ${rG(e)}`)}(n,r)}(s,n.ra(t));null!=i&&(r[t]=i)}),{mapValue:{fields:r}}}(r,u);if(i.merge)a=new eK(u.fieldMask),o=u.fieldTransforms;else if(i.mergeFields){let e=[];for(let r of i.mergeFields){let s=function(e,t,n){if((t=(0,l.m9)(t))instanceof sr)return t._internalPath;if("string"==typeof t)return sm(e,t);throw sg("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!u.contains(s))throw new T(E.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,s)||e.push(s)}a=new eK(e),o=u.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=u.fieldTransforms;return new so(new eQ(h),a,o)})(function(e){let t=e._freezeSettings(),n=nO(e._databaseId);return new sh(e._databaseId,!!t.ignoreUndefinedProperties,n)}(i),"setDoc",e._key,a,null!==e.converter,n).toMutation(e._key,tu.none())],function(e,t){let n=new I;return e.asyncQueue.enqueueAndForget(async()=>rN(await r9(e).then(e=>e.syncEngine),t,n)),n.promise}(se(i),s)}!function(e,t=!0){d=i.Jn,(0,i.Xd)(new a.wA("firestore",(e,{instanceIdentifier:n,options:r})=>{let s=e.getProvider("app").getImmediate(),i=new r8(new k(e.getProvider("auth-internal")),new _(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new T(E.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new W(e.options.projectId,t)}(s,n),s);return r=Object.assign({useFetchStreams:t},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),(0,i.KN)(h,"3.8.3",void 0),(0,i.KN)(h,"3.8.3","esm2017")}()}}]);